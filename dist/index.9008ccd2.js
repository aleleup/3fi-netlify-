...
})({"dedVX":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b4a7b2759008ccd2";
"use strict";
...
},{}],"2ZFhj":[function(require,module,exports) {
var _script1Js = require("./script1.js");
var _controllerJs = require("./controller.js"); // console.log(ourPeopleDisplayhtml(vlws.sebas));

},{"./script1.js":"ky1wF","./controller.js":"3hxdr"}],"ky1wF":[function(require,module,exports) {
// 'use strict'
...
// bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...
// bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla...bla bla bla... `
// const img1 = `graph1.fa33cb58.png` ///graph1.fa33cb58.png
// const img2 = `graph2.b981ea2b.png` //graph2.b981ea2b.png
// // When nav-button clicked, roll down to that section;
// // const headerLinks = document.querySelectorAll('.header-links');
// // const navLinks = document.querySelectorAll('header nav a');
// // window.onscroll = () => {
// //     headerLinks.forEach(sec => {
...
// //     })
// // }
// // When contact button clicked, display contact box. When close button clicked, undisplay it;
// const displayContactBox = function (x) {
...
//         }
//     })
//     closeContactButton.addEventListener('click', function (e) {
//         e.preventDefault;
//         contactBox.classList.add('hidden')
//     });
//     document.addEventListener('keydown', function (e) {
//         if (e.key === 'Escape') contactBox.classList.add('hidden')
//     });
// }
// // In Our-people section change the html image, and paragraphs.
// const ourPeopleDisplayhtml = function (worker) {
//     peopleNav.innerHTML = ''
//     const html = `
//     <div class="people-content">
//     <img src="${worker.img}" alt="Person">
//     <p class="tiny-font">${worker.func}: ${worker.worker}.
//     </p>
//     <p>Actually working in: ${worker.workingIn}, graduated in:${worker.graduationInfo}, expierences: ${worker.experiences} </p>
// </div>`;
//     return html
// }
// peopleNav.innerHTML = ourPeopleDisplayhtml(sebas);
// ourPeopleBtnBox.addEventListener('click', function (e) {
//     const targetContent = e.target.textContent
//     if (targetContent === 'CEO') {
//         peopleNav.innerHTML = ourPeopleDisplayhtml(sebas);
//         cfoButton.classList.remove('activated');
//         ceoButton.classList.add('activated')
//     }
//     if (targetContent === 'CFO') {
//         peopleNav.innerHTML = ourPeopleDisplayhtml(guille);
//         ceoButton.classList.remove('activated')
//         cfoButton.classList.add('activated');
//     }
//     else return
// })
// // slider
...
//     return html
// }
// aboutUsContent.innerHTML = aboutUsContentRenderHtml(text1, img1);
// nextPrevBtns.addEventListener('click', function (e) {
//     console.log(counter);
//     // NEXT BUTTON LOGIC
...
//         aboutUsContent.innerHTML = aboutUsContentRenderHtml(text2, img2);
//     }
//     if (counter === 2) {
//         next.classList.add('hidden');
//         dot2.classList.remove('dot--active')
//         dot3.classList.add('dot--active')
//         aboutUsContent.innerHTML = aboutUsContentRenderHtml(text3);
//     }
//     if (counter < 2) {
...
//     }
// })
// // console.log(aboutUsRenderHtml(text1, img1));
// // calling functions
// displayContactBox()
// // ourPeopleDisplayhtml()
...
},{"./controller.js":"3hxdr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3hxdr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "rolli", ()=>rolli);
...
},{}]},["dedVX","2ZFhj"], "2ZFhj", "parcelRequirec692")

//# sourceMappingURL=index.9008ccd2.js.map
